        ...
        <div class="row">
         ...
         <div class="col-xs-12 col-sm-12 col-md-12">
            ...
            <div class="form-group">
                ...
                <input type="status" class="form-control" name="status" value="{{ $peminjaman->status }}" placeholder="Input status">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            ...
            <div class="form-group">
                ...
                <select class="form-control" name="id_pegawai" id="id_pegawai">
                    ...
                    <option value="{{$pegawai->id}}" @if($pegawai->pegawai == $pegawai->id)selected @endif>{{$pegawai->id}} - {{$pegawai->nama}} </option>
                    @endforeach
                </select>
            </div>
